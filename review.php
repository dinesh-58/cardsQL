...
// NOTE: this is the old method of reviewing using session & 1 card per request, based on commit 994479a.
// a better, incomplete implementation is in ./review-new.php, which also has the proper version history for review.php
// TODO: after completing review-new.php, remove this file  & '-new' from its filename 
